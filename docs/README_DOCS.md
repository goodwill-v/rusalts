...
- `docs/ops/PARSER_CONTENT_QUEUE_ONEOFF.md` — разовый прогон Parser+Content через Redis
- `docs/ops/PIPELINE_AUTOMATION.md` — автоматизация daily Parser→Content→/publapprov/→/news/
- `docs/ops/ROUTERAI_MODEL_TESTING.md` — проверка RouterAI и ID моделей
- `docs/front/task_publapprov_news.md` — задание фронту: очередь одобрения + новости
